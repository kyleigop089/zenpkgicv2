...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const loadingMessage = await api.sendMessage("loading a random video from naos page, please wait...", event.threadID);

      const pageId = "100058154842595"; // Replace with the ID or username of the Facebook page
