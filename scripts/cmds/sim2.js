...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message }) {
    try {
      ...
      const response = await axios.get(`https://milanbhandari.imageapi.repl.co/simsimi?message=${encodeURIComponent(query)}`);
      ...
      console.error(error);
      api.sendMessage("System Busy!! My Developer (Samuel Kâñèñgeè) Is Fixing It....", event.threadID);
    }
  }
};
