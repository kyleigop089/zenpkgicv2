...
if (!info.adminIDs.some(item => item.id == api.getCurrentUserID())) return api.sendMessage('Need group admin permission\Please add and try again!', event.threadID, event.messageID);
