...
bankData[user].lastInterestClaimed = currentTime;
  ...
  if (balance < amount) {
    return message.reply("❌|The amount you wish to transfer is greater than your bank account balance check your balance.");
  }
  ...
  return message.reply(`✅|successfully transfer ${amount} to the receiver id ${recipientUID}.`);
} else {
